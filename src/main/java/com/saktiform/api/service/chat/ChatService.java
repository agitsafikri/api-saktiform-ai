    ...
    public void messageHandler(SendMessageDto data, String username) {
        ...
        try {
            ...
            if (messageType.equals("TEXT")) {
                ...
                response = client.sendAudio(waba.getPort(), contact.getPhoneNumber(), data.getMediaLink());
            }
            ...
            if (response.getCode().equals("SUCCESS")) {
                ...
                eventPublisher.publishEvent(ChatAsyncEvent.builder()
                        ...
                        .data(newChatUpdate)
                        .timestamp(chat.getSentAt().atZone(ZoneId.of("Asia/Jakarta")).format(formatter))
                        .build());
            ...
            throw new RuntimeException("Terjadi kesalahan saat mengirim pesan ke whatsapp, silahkan coba lagi.");
        }
